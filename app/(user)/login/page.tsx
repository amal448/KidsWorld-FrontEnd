            ...
            <div className="w-full max-w-md bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden relative">
                ...
                <div className="p-8 md:p-10 relative z-10">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 mt-2">Log in to continue your adventure.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full py-4 rounded-xl font-bold text-white transition-all shadow-lg shadow-primary/30 ${isLoading ? 'bg-slate-300 cursor-not-allowed' : 'bg-primary hover:bg-secondary hover:shadow-xl hover:-translate-y-1'}`}
                        >
